                            ...
                            <div className="Project-desc">
                                <div style={{height: '80%'}}>
                                    <Typography style={{fontSize: '15px'}}>
                                        This application's purpose is to help the user make song recommendations from Spotiy that can be tailored towards the user's 
                                        preference. The project was inspired by my own trouble finding new tracks to add to my playlist, and I would appreciate an that would enable 
